...
public class ServiceFragmentAdapter extends BaseAdapter {
    ...
    private int size;
    public ServiceFragmentAdapter(Context context, ArrayList<SERVICE_MESSAGE> messages) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.service_fragment_item, null);
            ...
            holder.item= (LinearLayout) view.findViewById(R.id.service_item);

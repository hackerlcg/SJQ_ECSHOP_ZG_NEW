...
import com.ecjia.hamster.adapter.GoodsChooseAdapter;
...
public class GoodsChooseActivity extends BaseActivity implements HttpResponse,OnClickListener,XListView.IXListViewListener {
    ...
    private void initView() {
        ...
        adapter=new GoodsChooseAdapter(goods,this);

        lv_gift_choose.setAdapter(adapter);

        adapter.setOnRightItemClickListener(new GoodsChooseAdapter.onRightItemClickListener() {
            @Override
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_add_choice:
                ...
                Intent intent=new Intent(GoodsChooseActivity.this,SelectGoodsActivity.class);
            ...
            case R.id.fragment_gifts_searchlayout:
                ...
                animation.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        Intent intent = new Intent(GoodsChooseActivity.this, SearchActivity.class);
        ...
        if(requestCode==100){
            ...
            if(requestCode==101&&resultCode==100){
               String goods=data.getStringExtra("goods");
                int goodsnum=data.getIntExtra("goodsnum",0);

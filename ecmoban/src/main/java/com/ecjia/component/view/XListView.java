...
public class XListView extends ListView implements OnScrollListener {
    ...
    public void setTopPullLoadMore(boolean topPullLoadMore) {
        mHeaderView.setTopPullLoadMore(topPullLoadMore);
    }
    ...
    public Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.obj.equals("stop_refresh")) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (getFirstVisiblePosition() == 0 && (mHeaderView.getVisiableHeight() > 0 || deltaY > 0)) {
                    ...
                    if (this.mEnablePullLoad) {//当有更多数据可加载时
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        ...
        if (autoLoadMore) {
            Log.i("XLISTVIEW", "lastVisibileItem == " + lastVisibileItem + "mListView.getCount() == " + view.getCount());
            Log.d("XLISTVIEW", "scrollState == " + scrollState + ", " + OnScrollListener.SCROLL_STATE_IDLE);
            if (scrollState == OnScrollListener.SCROLL_STATE_IDLE && (lastVisibileItem + 1) == view.getCount()) {
                startLoadMore();
            }
...
//        public void onAutoLoadMore(int id);
    }
    ...
    public void setmHeaderViewText() {

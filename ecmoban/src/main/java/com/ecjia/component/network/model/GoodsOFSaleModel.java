...
public class GoodsOFSaleModel extends BaseModel {

    public MyProgressDialog pd;

	public GoodsOFSaleModel(Context context)
	{
		super(context);
    ...
    public void GoodsSale(SESSION session,String id,String type,String api){
        final String url = ProtocolConst.GOODSSALE;
//           pd.show();
                ...
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> arg0) {
                        ...
                        try {
                            ...
                            GoodsOFSaleModel.this.OnMessageResponse(url,jo,responseStatus);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }

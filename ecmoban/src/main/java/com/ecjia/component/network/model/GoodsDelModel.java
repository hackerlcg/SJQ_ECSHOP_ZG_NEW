...
public class GoodsDelModel extends BaseModel {

    public MyProgressDialog pd;

	public GoodsDelModel(Context context)
	{
		super(context);
    ...
    public void GoodsDel(SESSION session,String id,String api){
        final String url = ProtocolConst.GOODSDEL;
//           pd.show();
                ...
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> arg0) {
                        ...
                        try {
                            ...
                            GoodsDelModel.this.OnMessageResponse(url,jo,responseStatus);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }

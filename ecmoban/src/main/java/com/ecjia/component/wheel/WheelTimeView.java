...
public class WheelTimeView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xff555555;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xffc4c4c4;

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] { 0x90ffffff,
			0x60ffffff, 0x00ffffff };
